...
export function Inventory() {
  ...
  const [checkoutReports, setCheckoutReports] = useState(mockCheckoutReports);
  ...
  const damageCosts = checkoutReports.reduce((sum, r) => sum + r.totalDamageCost, 0);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-6">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Damage Costs</CardTitle>
            <Wrench className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">{formatCurrency(damageCosts)}</div>
            <p className="text-xs text-muted-foreground">
              This month
            </p>
          </CardContent>
