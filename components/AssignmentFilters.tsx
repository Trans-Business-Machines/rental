...
export function AssignmentFilters({
  ...
  const hasActiveFilters =
    searchParams.get("assignmentProperty") ||
      ...
      <div className="flex flex-col sm:flex-row gap-4 flex-1">
        ...
        <div className="min-w-[350px">
          <Select
            ...
            onValueChange={(value) =>
              updateSearchParams("assignmentProperty", value)
            }
          >
        ...
        <div className="min-w-[200px]">
          <Select
            ...
            onValueChange={(value) =>
              updateSearchParams("assignmentItem", value)
            }
          >
            <SelectTrigger className="w-full">
        ...
        <div className="min-w-[250px]">
          <Select
            ...
            onValueChange={(value) =>
              updateSearchParams("assignmentStatus", value)
            }
          >
            <SelectTrigger className="w-full">
