...
export default function AmenitiesPage() {
  ...
  const activeAmenities = amenities.filter((a) => a.status === "active").length;
  ...
  const stats: StatCardsProps[] = [
    {
      ...
      subtitle: `${activeAmenities} active`,
      color: "blue",
    },
    {
      ...
      icon: Users,
      value: totalCapacity,
      subtitle: "spots/units available",
      color: "green",
    },
    {
      ...
      subtitle: `${Math.round((totalAvailable / totalCapacity) * 100)}% availability`,
      color: "",
    },
    {
      title: "Occupied",
      icon: Calendar,
      value: totalCapacity - totalAvailable,
          ...
          <DialogContent className="max-w-md">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <Label htmlFor="maxBookingHours" className="mb-2 block">
                    Max Hours
                  </Label>
                  <Input
                    id="maxBookingHours"
              ...
              <div>
                <Label htmlFor="hourlyRate" className="mb-2 block">
                  Hourly Rate ($)
                </Label>
                <Input
                  id="hourlyRate"
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    ...
                    <p className="font-medium">{amenity.total}</p>
                  </div>
                  <div>
                    <span className="text-muted-foreground">Max Booking</span>
                    <p className="font-medium">{amenity.maxBookingHours}h</p>
                  </div>
                  <div>
                ...
                <div className="border-t pt-3">
                  <p className="text-sm font-medium mb-1">Rules & Guidelines</p>
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent className="max-w-md">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="gym">Gym/Fitness</SelectItem>
                  <SelectItem value="pool">Swimming Pool</SelectItem>
                  <SelectItem value="community_room">Community Room</SelectItem>
                  <SelectItem value="bbq">BBQ Area</SelectItem>
                  <SelectItem value="garden">Garden/Outdoor</SelectItem>
                </SelectContent>
              </Select>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <Label htmlFor="edit-total" className="mb-2 block">
                  Total Capacity
                </Label>
                <Input
                  id="edit-total"
              ...
              <div>
                <Label htmlFor="edit-maxBookingHours" className="mb-2 block">
                  Max Hours
                </Label>
                <Input
            ...
            <div>
              <Label htmlFor="edit-hourlyRate" className="mb-2 block">
                Hourly Rate ($)
              </Label>
              <Input
                id="edit-hourlyRate"
