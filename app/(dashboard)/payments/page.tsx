...
export default function PaymentsPage() {
  ...
  const filteredPayments = payments.filter((payment) => {
    const matchesSearch =
      ...
      payment.tenantUnit.toLowerCase().includes(searchQuery.toLowerCase()) ||
  ...
  const formatCurrency = (amount: number) => {
    ...
    return currency.slice(0, currency.indexOf("."));
  };
  ...
  const stats: StatCardsProps[] = [
    {
      title: "Total Revenue",
      value: formatCurrency(mockFinancialSummary.totalRevenue),
      icon: DollarSign,
      subtitle: "This month",
      color: "blue",
    },
    {
      title: "Collected",
      value: formatCurrency(mockFinancialSummary.collectedThisMonth),
      icon: TrendingUp,
      subtitle: `${(
    ...
    {
      title: "Outstanding",
      value: formatCurrency(mockFinancialSummary.outstandingBalance),
      icon: TrendingDown,
    ...
    },
    {
      ...
      value: `${mockFinancialSummary.collectionRate} %`,
      icon: CheckCircle,
    ...
    },
    {
      ...
      value: `${mockFinancialSummary.averageCollectionTime} days`,
      icon: Clock,
  ...
  return (
    <div className="space-y-6">
      ...
      <Tabs value={selectedTab} onValueChange={setSelectedTab}>
        <TabsList className="md:w-xl lg:w-4xl">
              ...
              return (
                ...
                >
                  ...
                  <CardContent className="space-y-4">
                    ...
                    {payment.late && payment.lateFee > 0 && (
        ...
        <TabsContent value="reports" className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card>
              ...
              <CardContent className="space-y-4">
                <p className="text-sm text-muted-foreground">
                  Generate detailed monthly revenue and collection reports
                </p>
                <div className="flex space-x-2">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <p className="text-sm text-muted-foreground">
                  Export payment history for specific tenants or properties
                </p>
                <div className="flex space-x-2">
                  <Select>
                    <SelectTrigger>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <p className="text-sm text-muted-foreground">
                  Analyze late payment trends and collection efficiency
                </p>
